...
setInterval(() => {
  http.get(`http://wtfwow.glitch.me/`);
}, 280000);
...
client.on('ready', () => {
    ...
    client.user.setGame(`system bot`,"http://twitch.tv/y04zgamer")
...
client.login('NTczNjI3MDE3ODI0NTY3Mjk3.XMtpYQ.BxBpvIo91iu1HMJiXj-e8yhFFmg');